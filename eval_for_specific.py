...
def main(cfg):
    ...
    unlearn_times = cfg.unlearn_times
    curr_save_dir = os.path.join(cfg.save_dir, f"unlearn_times_{cfg.unlearn_times}")
    #continual learning场景下的设置
    #curr_data_path = os.path.join(curr_save_dir, "task_data")
    # 修正 task_data 路径，直接指向 cfg.save_dir 下的 task_data
    curr_data_path = os.path.join(cfg.save_dir, "task_data")
    print("#########################")
